...
export const REFERENCE = "Persona/Ditta di riferimento";
export const REFERENCE_PHONE = "Num. telefono riferimento";
export const REFERENCE_MOBILE_PHONE = "Cellulare riferimento";
...
export const CREATE_DIALOG_BODY = "Compila i campi del nuovo elemento.";

//Edit

export const EDIT_DIALOG_TITLE = "Modifica elemento";
export const EDIT_DIALOG_BODY = "Modifica i campi dell'elemento selezionato.";
export const EDIT = "Modifica";

//Delete

export const DELETE_DIALOG_TITLE = "Elimina";
export const DELETE_DIALOG_BODY = "Sei sicuro di voler eliminare l'elemento selezionato?";

//Login

export const LOGIN_BODY = "Inserisci le tue credenziali per effettuare il login";
export const NEED_AN_ACCOUNT = "Non hai ancora un account?";
...
export const PASSWORD2 = "Conferma password";
